...
namespace Vente.Controllers
{
    public class ProduitsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IDP"] = new SelectList(_context.Proprietaires, "IDUtilisateur", "IDUtilisateur");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPr,Name,Description,prix,IDC,IDP,DateExpiration,ImageData")] Produit produit)
        {
            ...
            ViewData["IDP"] = new SelectList(_context.Proprietaires, "IDUtilisateur", "IDUtilisateur", produit.IDP);
            return View(produit);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPr,Name,Description,prix,IDC,IDP,DateExpiration,ImageData")] Produit produit)
        {
            if (id != produit.IdPr)
            {
                return NotFound();
